(** * This is the univalent or h- version of the standard library file Datatypes.v 

The types Empty_set , unit, bool and nat are now introduced in uuu.v *)


Set Implicit Arguments.

Require Import Notations.
Require Import hLogic_r.
Declare ML Module "nat_syntax_plugin".

Notation Empty_set := empty .
...
Lemma neqfalsetrue : ~ ( false = true ) .
Proof. intro X.  simpl. simpl in X.  apply hinhuniv with hfalse.  intro. assumption. apply hinhfunct with (paths _ false true). intro x.   apply nopathsfalsetotrue. assumption.  assumption. 
Defined. 
...
Proof.
  destruct a; destruct b; intros; split. apply eq_refl.   apply eq_refl.  apply eq_refl. auto.   auto. auto. auto. auto. 
Defined.
...
Proof.
  destruct b1; destruct b2; simpl in |- *. intro. apply eq_refl.   intro x.  apply (pr22 _ _ x).  intro x. apply (pr21 _ _ x ) . intro x. apply ( pr22 _ _ x ) .
Defined.
Hint Resolve andb_true_intro: bool.

(** Interpretation of booleans as propositions *)

Definition eq_true : bool -> hProp := 
fun b : bool => match b with
true => True |
false => False end. 

(** * The following line does not work since eq_true is not an inductive definition anymore. 
...
Lemma eq_true_ind_r :
  forall (P : bool -> hProp) (b : bool), P b -> eq_true b -> P true.
Proof.
  intros P b H H0.  destruct b. assumption. simpl in H0. destruct H0. 
Defined.

Lemma eq_true_rec_r :
  forall (P : bool -> UU0 ) (b : bool), P b -> eq_true b -> P true.
Proof.
  intros P b H H0. destruct b.  assumption. simpl in H0. destruct H0.  
Defined.
