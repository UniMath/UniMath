...
Definition isfinitestn (n:nat): isfinite (stn n) := isinh1pr _ (finitestructstn n). 

Definition finitestructempty := finitestructpair _ O (idweq _).
Definition isfiniteempty : isfinite empty := isinh1pr _ finitestructempty.

Definition finitestructunit: finitestruct unit := finitestructpair _ (S O) (weqfromcoprodwithempty unit).
Definition isfiniteunit : isfinite unit := isinh1pr _ finitestructunit. 
...
Definition isfinitebool : isfinite bool  := isinh1pr _ finitestructbool.

Definition finitestructinitinterval (n:nat) := finitestructpair _ (S n) (weqstntoinitinterval n).
Definition isfiniteinitinterval (n:nat):= isinh1pr _ (finitestructinitinterval n).
...
Proof. intros. apply (isinh1funct _ _ (finitestructfromcomplement X x is) X0). Defined. 
...
Proof. intros.  apply (isinh1funct _ _ (finitestructsummand X Y) is). Defined. 
...
Proof. intros. apply  (isinh1funct _ _ (finitestructsubset X f) X0). Defined. 
