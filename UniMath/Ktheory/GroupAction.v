...
Proof. induction X as [X [Xm Xu Xa]], Y as [Y [Ym Yu Ya]].
...
Proof. induction p as [p i], q as [q j]. exists (funcomp p q).
...
Proof. induction e as [e i], f as [f j]. exists (weqcomp e f).
...
Proof. induction X as [X x]. exists (triviality_isomorphism X x).
