...
Module Uniqueness.
  ...
  Proof. intros. simple refine (_,,iso_isweq _ _ _ _).
         { intros h. split.
     ...
     (∑ f:∏ n, P n, (f 0=p0) × (∏ n, f(S n)=IH n (f n)))
       ≃
        (@hfiber
           ...
           (λ fh, pr1 fh 0)
           p0).
  Proof. intros. simple refine (weqpair _ (iso_isweq _ _ _ _)).
...
Module Discern.
  ...
  Proof. intros. simple refine (iso_isweq _ (helper_C _ _) _ _).
