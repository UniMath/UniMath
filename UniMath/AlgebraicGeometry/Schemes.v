...
(* TODO: Show that a scheme is not only a ringed space, but also a *locally* ringed space *)
(* TODO: Show that a presheafed space is a ringed space if it is locally isomorphic to an affine scheme *)
