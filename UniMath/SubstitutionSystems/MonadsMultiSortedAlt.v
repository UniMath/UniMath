...
Local Definition bind_instantiated {T : Monad sortToSet} {Γ1 Γ2 : sortToSet} (f : sortToSet⟦Γ1,T Γ2⟧) :
  sortToSet⟦T Γ1,T Γ2⟧ := bind f.

Context {T : Monad sortToSet}.

Definition wellsorted_in (Γ : sortToSet) : hSet.
   Check (pr1 T Γ). := pr1 T Γ.
