...
(and adding SimplifiedHSS to the fully qualified identifiers)
...
Definition BindingSig : UU :=
  @UniMath.SubstitutionSystems.SimplifiedHSS.BindingSigToMonad.BindingSig.
...
Definition BindingSigToSignature :
  ...
  → ∏ sig : BindingSig, Coproducts (BindingSigIndex sig) C →
    Signature C C C :=
    @UniMath.SubstitutionSystems.SimplifiedHSS.BindingSigToMonad.BindingSigToSignature.
...
Proof.
exact @UniMath.SubstitutionSystems.SimplifiedHSS.BindingSigToMonad.is_omega_cocont_BindingSigToSignature.
Defined.
...
Proof.
exact @UniMath.SubstitutionSystems.SimplifiedHSS.BindingSigToMonad.DatatypeOfBindingSig.
Defined.
...
Proof.
exact @UniMath.SubstitutionSystems.SimplifiedHSS.LiftingInitial_alt.InitHSS.
Defined.
...
Proof.
exact @UniMath.SubstitutionSystems.SimplifiedHSS.LiftingInitial_alt.isInitial_InitHSS.
Defined.
...
Definition BindingSigToMonad :
  ...
  → Monad C.
Proof.
  exact @UniMath.SubstitutionSystems.SimplifiedHSS.BindingSigToMonad.BindingSigToMonad.
Defined.
