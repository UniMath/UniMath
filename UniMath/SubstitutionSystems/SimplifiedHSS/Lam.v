...
(** version for simplified notion of HSS by Ralph Matthes (2022, 2023)
    the file is identical to the homonymous file in the parent directory,
    except for importing files from the present directory and
    WARNING: a big part of the previous development is commented out since
    the adaptation does to seem to be smooth here *)
