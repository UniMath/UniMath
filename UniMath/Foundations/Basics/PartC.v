...
assert ( egf : forall t : T , paths ( g ( f t ) ) t ) . intro .  refine (homottranspost2t1t1t2 _ _ _ _ _).
assert ( efg : forall t : T , paths ( f ( g t ) ) t ) . intro .  refine (homottranspost2t1t1t2 _ _ _ _ _).
