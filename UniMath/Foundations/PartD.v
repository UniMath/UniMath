...
Proof.
  intros.
  simple refine (iso_isweq (foralltototal P PP) (totaltoforall P PP) _ _).
  - apply idpath.
  - apply idpath.
Defined.
...
Proof.
  intros.
  simple refine (iso_isweq (totaltoforall P PP) (foralltototal P PP) _ _).
  - apply idpath.
  - apply idpath.
Defined.
...
Proof.
  intros.
  simple refine (weqpair _ (iso_isweq (@funtoprodtoprod X Y Z)
...
Proof.
  ...
  apply (iso_isweq map invmapp egf efg).
Defined.
...
Proof.
  intros.
  simple refine (
           weqpair _ (iso_isweq (@funfromcoprodtoprod X Y Z)
...
Proof.
  intros. simple refine (iso_isweq _ _ _ _).
