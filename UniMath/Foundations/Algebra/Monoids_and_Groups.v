...
Definition submonoidstosubsetswithbinop ( X : monoid ) : @submonoids X -> @subsetwithbinop X := fun A : _ => subsetwithbinoppair ( pr1 A ) ( pr1 ( pr2 A ) ) .
Coercion  submonoidstosubsetswithbinop : submonoids >-> subsetwithbinop .
...
Definition carrierofsubabmonoids { X : abmonoid } ( A : @subabmonoids X ) : abmonoid .
Proof . intros . unfold subabmonoids in A . split with A . apply isabmonoidcarrier . Defined .

Coercion carrierofsubabmonoids : subabmonoids >-> abmonoid .
...
(* ??? could the use of [ issubabmonoids ] in [ binopeqrelabmonoidfrac ] and [ submonoids ] in [ abmonoidfrac ] lead to complications for the unification machinery? See also [ abmonoidfracisbinoprelint ] below . *)
...
Definition subgrstosubmonoidss ( X : gr ) : @subgrs X -> submonoids X := fun A : _ => submonoidpair ( pr1 A ) ( pr1 ( pr2 A ) ) .
Coercion subgrstosubmonoidss : subgrs >-> submonoids .
