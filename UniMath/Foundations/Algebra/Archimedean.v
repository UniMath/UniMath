...
Lemma natmult_commrngfrac {X : commrng} {S : subabmonoid (rngmultabmonoid X)} :
...
Lemma isarchcommrngfrac {X : commrng} {S : subabmonoid (rngmultabmonoid X)} (R : hrel X) Hop1 Hop2 Hs:
  R 1%rng 0%rng ->
  istrans R ->
