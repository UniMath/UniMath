...
Lemma natmult_commrngfrac {X : commrng} {S : @subabmonoids (rngmultabmonoid X)} :
...
Lemma isarchcommrngfrac {X : commrng} {S : @subabmonoids (rngmultabmonoid X)} (R : hrel X) Hop1 Hop2 Hs:
  R 1%rng 0%rng ->
  istrans R ->
