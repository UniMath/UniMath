...
Definition natdecleast ( F : nat -> UU ) ( is : ∏ n , isdecprop ( F n ) ) := total2 ( λ  n : nat, dirprod ( F n ) ( ∏ n' : nat , F n' -> natleh n n' ) ) .
