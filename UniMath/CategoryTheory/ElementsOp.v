...
Lemma make_ob_eq {I : C} {x y} (e : x = y) :
  make_ob I x = make_ob I y.
Proof.
apply pair_path_in2, e.
Defined.

Lemma base_paths_make_ob_eq {I : C} x y (e : x = y) :
  base_paths _ _ (make_ob_eq e) = idpath I.
Proof.
...
Proof.
exact (make_ob_eq (eqtohomot (functor_id X I) ρ)).
Defined.
...
Proof.
exact (make_ob_eq (eqtohomot (functor_comp X f g) ρ)).
Defined.
