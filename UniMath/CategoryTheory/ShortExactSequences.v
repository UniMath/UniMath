...
Section def_shortexactseqs.
  ...
  Definition ShortShortExactData_Im (SSED : ShortShortExactData A (Abelian_Zero A)) :
    Kernel (Abelian_Zero A)
           (CokernelArrow (Abelian_Zero A) (Abelian_Cokernel A (MorphismPairMor1 A SSED))) :=
    Abelian_Im A (MorphismPairMor1 A SSED).

  Lemma ShortShortExactData_Im_Eq (SSED : ShortShortExactData A (Abelian_Zero A)) :
    (KernelArrow (Abelian_Zero A) (ShortShortExactData_Im SSED))
      ;; (MorphismPairMor2 A SSED) = ZeroArrow A (Abelian_Zero A) _ _.
  Proof.
    unfold ShortShortExactData_Im.
    set (fact := Abelian_factorization1 A hs (MorphismPairMor1 A SSED)).
    unfold Abelian_factorization1_monic in fact. cbn in fact.
    apply (Abelian_factorization1_is_epi A hs (MorphismPairMor1 A SSED)).
  ...
  Definition ShortShortExactData_CoIm (SSED : ShortShortExactData A (Abelian_Zero A)) :
    Cokernel (Abelian_Zero A)
             (KernelArrow (Abelian_Zero A) (Abelian_Kernel A (MorphismPairMor2 A SSED))) :=
    Abelian_CoIm A (MorphismPairMor2 A (ShortShortExactData_MorphismPair A (Abelian_Zero A) SSED)).

  Lemma ShortShortExactData_CoIm_Eq (SSED : ShortShortExactData A (Abelian_Zero A)) :
    (MorphismPairMor1 A SSED) ;; (CokernelArrow (Abelian_Zero A) (ShortShortExactData_CoIm SSED)) =
    ZeroArrow A (Abelian_Zero A) _ _.
  Proof.
    unfold ShortShortExactData_CoIm.
    set (fact := Abelian_factorization2 A hs (MorphismPairMor2 A SSED)).
    unfold Abelian_factorization2_epi in fact. cbn in fact.
    apply (Abelian_factorization2_is_monic A hs (MorphismPairMor2 A SSED)).
  ...
  *)
  ...
  Definition ShortShortExact : UU
    := Σ SSED : ShortShortExactData A (Abelian_Zero A),
                isEqualizer (MorphismPairMor2 A SSED)
                            (ZeroArrow A (Abelian_Zero A) _ _)
                            (KernelArrow (Abelian_Zero A) (ShortShortExactData_Im SSED))
                            (KernelEqRw (Abelian_Zero A) (ShortShortExactData_Im_Eq SSED)).

  Definition mk_ShortShortExact (SSED : ShortShortExactData A (Abelian_Zero A))
             (H : isEqualizer (MorphismPairMor2 A SSED)
                              (ZeroArrow A (Abelian_Zero A) _ _)
                              (KernelArrow (Abelian_Zero A) (ShortShortExactData_Im SSED))
                              (KernelEqRw (Abelian_Zero A) (ShortShortExactData_Im_Eq SSED))) :
    ShortShortExact.
  ...
  Definition ShortShortExact_isEqualizer (SSE : ShortShortExact) :
    isEqualizer (MorphismPairMor2 A SSE)
                (ZeroArrow A (Abelian_Zero A) _ _)
                (KernelArrow (Abelian_Zero A) (ShortShortExactData_Im SSE))
                (KernelEqRw (Abelian_Zero A) (ShortShortExactData_Im_Eq SSE)) := pr2 SSE.

  Definition ShortShortExact_Kernel (SSE : ShortShortExact) :
    Kernel (Abelian_Zero A) (MorphismPairMor2 A SSE) :=
    mk_Kernel (Abelian_Zero A)
              (KernelArrow (Abelian_Zero A) (ShortShortExactData_Im SSE))
              (MorphismPairMor2 A SSE)
              (ShortShortExactData_Im_Eq SSE)
  ...
  *)
  ...
  Definition LeftShortExact : UU := Σ SSE : ShortShortExact, isMonic A (MorphismPairMor1 A SSE).

  Definition mk_LeftShortExact (SSE : ShortShortExact) (isM : isMonic A (MorphismPairMor1 A SSE)) :
    LeftShortExact.
  Proof.
    use tpair.
    - exact SSE.
  ...
  Definition LeftShortExact_isMonic (LSE : LeftShortExact) : isMonic A (MorphismPairMor1 A LSE) :=
    pr2 LSE.
  ...
  Definition RightShortExact : UU := Σ SSE : ShortShortExact, isEpi A (MorphismPairMor2 A SSE).

  Definition mk_RightShortExact (SSE : ShortShortExact) (isE : isEpi A (MorphismPairMor2 A SSE)) :
    RightShortExact.
  Proof.
    use tpair.
    - exact SSE.
  ...
  Definition RightShortExact_isEpi (RSE : RightShortExact) : isEpi A (MorphismPairMor2 A RSE) :=
    pr2 RSE.
  ...
  *)
  ...
  Definition ShortExact : UU
    := Σ SSE : ShortShortExact,
               isMonic A (MorphismPairMor1 A SSE) × isEpi A (MorphismPairMor2 A SSE).

  Definition mk_ShortExact (SSE : ShortShortExact) (isM : isMonic A (MorphismPairMor1 A SSE))
             (isE : isEpi A (MorphismPairMor2 A SSE)) : ShortExact.
  Proof.
    use tpair.
    - exact SSE.
    - use dirprodpair.
  ...
  Definition ShortExact_isMonic (SE : ShortExact) : isMonic A (MorphismPairMor1 A SE) :=
    pr1 (pr2 SE).

  Definition ShortExact_isEpi (SE : ShortExact) : isEpi A (MorphismPairMor2 A SE) := pr2 (pr2 SE).
...
Section shortshortexact_coequalizer.
  ...
  Lemma ShortShortExact_isCoequalizer_eq1 (SSE : ShortShortExact A hs) (w0 : A)
        (h : A ⟦MorphismPairOb2 A SSE, w0⟧)
        (H : MorphismPairMor1 A SSE ;; h = (ZeroArrow A (Abelian_Zero A) _ _) ;; h) :
    (KernelArrow (Abelian_Zero A) (ShortShortExact_Kernel A hs SSE)) ;; h =
    ZeroArrow A (Abelian_Zero A) _ _.
  Proof.
    apply (Abelian_factorization1_is_epi A hs (MorphismPairMor1 A SSE)).
    set (tmp := Abelian_factorization1 A hs (MorphismPairMor1 A SSE)).
  ...
  Lemma ShortShortExact_isCoequalizer_eq2 (SSE : ShortShortExact A hs) (w0 : A)
        (h : A ⟦MorphismPairOb2 A SSE, w0⟧)
        (H : MorphismPairMor1 A SSE ;; h = (ZeroArrow A (Abelian_Zero A) _ _) ;; h) :
    KernelArrow (Abelian_Zero A) (Abelian_Kernel A (MorphismPairMor2 A SSE)) ;; h =
    ZeroArrow A (Abelian_Zero A) _ _.
  Proof.
    set (i := iso_from_Kernel_to_Kernel (Abelian_Zero A) (ShortShortExact_Kernel A hs SSE)
                                        (Abelian_Kernel A (MorphismPairMor2 A SSE))).
  ...
  Definition ShortShortExact_isCoequalizer (SSE : ShortShortExact A hs) :
    isCoequalizer (MorphismPairMor1 A SSE) (ZeroArrow A (Abelian_Zero A) _ _)
                  (CokernelArrow (Abelian_Zero A) (ShortShortExactData_CoIm A SSE))
                  (CokernelEqRw (Abelian_Zero A) (ShortShortExactData_CoIm_Eq A hs SSE)).
  Proof.
    ...
    - apply (CokernelOut (Abelian_Zero A) (ShortShortExactData_CoIm A SSE) w0 h
  ...
  Definition ShortShortExact_Coequalizer (SSE : ShortShortExact A hs) :
    Cokernel (Abelian_Zero A) (MorphismPairMor1 A SSE) :=
    mk_Cokernel (Abelian_Zero A) (CokernelArrow (Abelian_Zero A) (ShortShortExactData_CoIm A SSE))
                (MorphismPairMor1 A SSE) (ShortShortExactData_CoIm_Eq A hs SSE)
  ...
  Lemma ShortShortExact_from_isCoequalizer_eq1 (SSED : ShortShortExactData A (Abelian_Zero A))
        (w : A) (h : A ⟦w, MorphismPairOb2 A SSED⟧)
        (H : (h ;; (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A (MorphismPairMor2 A SSED))))
             = ZeroArrow A (Abelian_Zero A) _ _)
        (H' : isCoequalizer (MorphismPairMor1 A SSED) (ZeroArrow A (Abelian_Zero A) _ _)
                            (CokernelArrow (Abelian_Zero A) (ShortShortExactData_CoIm A SSED))
                (CokernelEqRw (Abelian_Zero A) (ShortShortExactData_CoIm_Eq A hs SSED))):
    h ;; CokernelArrow (Abelian_Zero A) (Abelian_Cokernel A (MorphismPairMor1 A SSED)) =
    ZeroArrow A (Abelian_Zero A) _ _.
  Proof.
    set (coker := mk_Cokernel (Abelian_Zero A)
                              (CokernelArrow (Abelian_Zero A) (ShortShortExactData_CoIm A SSED))
                              (MorphismPairMor1 A SSED) (ShortShortExactData_CoIm_Eq A hs SSED) H').
    set (i := iso_from_Cokernel_to_Cokernel (Abelian_Zero A)
                                            (Abelian_Cokernel A (MorphismPairMor1 A SSED)) coker).
  ...
  Lemma ShortShortExact_from_isCoequalizer_eq2 (SSED : ShortShortExactData A (Abelian_Zero A))
        (w : A) (h : A ⟦w, MorphismPairOb2 A SSED⟧)
        (H : h ;; MorphismPairMor2 A SSED = h ;; (ZeroArrow A (Abelian_Zero A) _ _))
        (H' : isCoequalizer (MorphismPairMor1 A SSED) (ZeroArrow A (Abelian_Zero A) _ _)
                            (CokernelArrow (Abelian_Zero A) (ShortShortExactData_CoIm A SSED))
                            (CokernelEqRw (Abelian_Zero A)
                                          (ShortShortExactData_CoIm_Eq A hs SSED))) :
    h ;; CokernelArrow (Abelian_Zero A) (Abelian_CoIm A (MorphismPairMor2 A SSED)) =
    ZeroArrow A (Abelian_Zero A) _ _.
  Proof.
    apply (Abelian_factorization2_is_monic A hs (MorphismPairMor2 A SSED)).
    set (tmp := Abelian_factorization2 A hs (MorphismPairMor2 A SSED)).
  ...
  Lemma ShortShortExact_from_isCoequalizer_isEqualizer
        ...
        (H : isCoequalizer (MorphismPairMor1 A SSED) (ZeroArrow A (Abelian_Zero A) _ _)
                           ...
                           (CokernelEqRw (Abelian_Zero A)
                                         (ShortShortExactData_CoIm_Eq A hs SSED))) :
    isEqualizer (MorphismPairMor2 A SSED) (ZeroArrow A (Abelian_Zero A) _ _)
                (KernelArrow (Abelian_Zero A) (ShortShortExactData_Im A SSED))
                (KernelEqRw (Abelian_Zero A) (ShortShortExactData_Im_Eq A hs SSED)).
  Proof.
    use mk_isEqualizer.
    intros w h H'.
    use unique_exists.
    ...
    (* Construction of the morphism *)
    - apply (KernelIn (Abelian_Zero A) (ShortShortExactData_Im A SSED) w h
  ...
  Definition ShortShortExact_from_isCoequalizer (SSED : ShortShortExactData A (Abelian_Zero A))
             (H : isCoequalizer (MorphismPairMor1 A SSED) (ZeroArrow A (Abelian_Zero A) _ _)
                                (CokernelArrow (Abelian_Zero A) (ShortShortExactData_CoIm A SSED))
                                (CokernelEqRw (Abelian_Zero A)
                                              (ShortShortExactData_CoIm_Eq A hs SSED))) :
    ShortShortExact A hs := mk_ShortShortExact
...
Section shortexact_correspondence.
  ...
  Lemma ShortExact_from_ShortShortExact_eq (SSE : ShortShortExact A hs) :
    (KernelArrow (Abelian_Zero A) (Abelian_Im A (MorphismPairMor1 A SSE)))
      ;; (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A (MorphismPairMor2 A SSE))) =
    ZeroArrow A (Abelian_Zero A) _ _.
  Proof.
    (* Work on mor1 using factorization *)
    apply (Abelian_factorization1_is_epi A hs (MorphismPairMor1 A SSE)).
    rewrite assoc.
    set (fact := Abelian_factorization1 A hs (MorphismPairMor1 A SSE)).
    rewrite ZeroArrow_comp_right.
    unfold Abelian_factorization1_monic in fact. cbn in fact. rewrite <- fact. clear fact.

    (* Work on mor2 using factorization *)
    apply (Abelian_factorization2_is_monic A hs (MorphismPairMor2 A SSE)).
    rewrite <- assoc.
    set (fact := Abelian_factorization2 A hs (MorphismPairMor2 A SSE)).
    unfold Abelian_factorization2_epi in fact. cbn in fact. rewrite <- fact. clear fact.
    rewrite ZeroArrow_comp_left.

    apply (ShortShortExactData_Eq A (Abelian_Zero A) SSE).
  Qed.

  Definition ShortExact_ShortShortExact_isEqualizer_Eq (SSE : ShortShortExact A hs) (w : A)
             (h : A ⟦w, MorphismPairOb2 A SSE⟧)
             (H' : h ;; CokernelArrow (Abelian_Zero A) (Abelian_CoIm A (MorphismPairMor2 A SSE))
                   = ZeroArrow A (Abelian_Zero A) _ _) :
    let Im := (Abelian_Im A (MorphismPairMor1 A SSE)) in
    h ;; (CokernelArrow (Abelian_Zero A) (Abelian_Cokernel A (KernelArrow (Abelian_Zero A) Im)))
    = ZeroArrow A (Abelian_Zero A) _ _.
  Proof.
    cbn zeta.

    assert (X : h ;; MorphismPairMor2 A SSE = ZeroArrow A (Abelian_Zero A) _ _).
    {
      rewrite (Abelian_factorization2 A hs (MorphismPairMor2 A  SSE)).
      unfold Abelian_factorization2_epi. cbn.
      set (tmp := Abelian_factorization2_monic A hs (MorphismPairMor2 A SSE)).
    ...
    set (comm1 := KernelCommutes (Abelian_Zero A) (Abelian_Kernel A (MorphismPairMor2 A SSE)) w h
                                 X).
    set (ker := ShortShortExact_Kernel A hs SSE).

    set (tmp := Abelian_Kernel A (MorphismPairMor2 A SSE)).
    set (tmp_eq := (KernelEqAr (Abelian_Zero A) tmp)).
    rewrite ZeroArrow_comp_right in tmp_eq.
    set (comm2 := KernelCommutes (Abelian_Zero A) ker tmp (KernelArrow (Abelian_Zero A) tmp)
                                 tmp_eq).
  ...
  Definition ShortExact_ShortShortExact_isEqualizer (SSE : ShortShortExact A hs) :
    let Im := Abelian_Im A (MorphismPairMor1 A SSE) in
    let CoIm := Abelian_CoIm A (MorphismPairMor2 A SSE) in
    let MP := mk_MorphismPair A (KernelArrow (Abelian_Zero A) Im)
                              (CokernelArrow (Abelian_Zero A) CoIm) in
    let SSED := mk_ShortShortExactData A (Abelian_Zero A) MP
                                       (ShortExact_from_ShortShortExact_eq SSE) in

    isEqualizer (CokernelArrow (Abelian_Zero A) CoIm) (ZeroArrow A (Abelian_Zero A) _ _)
                (KernelArrow (Abelian_Zero A) (ShortShortExactData_Im A SSED))
                (KernelEqRw (Abelian_Zero A) (ShortShortExactData_Im_Eq A hs SSED)).
  Proof.
    cbn zeta.
  ...
  Definition ShortExact_from_ShortShortExact (SSE : ShortShortExact A hs) : ShortExact A hs.
  Proof.
    use mk_ShortExact.
    - use mk_ShortShortExact.
      + use mk_ShortShortExactData.
        * use mk_MorphismPair.
          -- exact (Abelian_Im A (MorphismPairMor1 A SSE)).
          -- exact (MorphismPairOb2 A SSE).
          -- exact (Abelian_CoIm A (MorphismPairMor2 A SSE)).
          -- exact (KernelArrow (Abelian_Zero A) (Abelian_Im A (MorphismPairMor1 A SSE))).
          -- exact (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A (MorphismPairMor2 A SSE))).
  ...
  Lemma ShortShortExact_from_isSortExact_eq {a b c : A} (f : a --> b) (g : b --> c)
             (H : (KernelArrow (Abelian_Zero A) (Abelian_Im A f))
                    ;; (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A g))
                  = ZeroArrow A (Abelian_Zero A) _ _)
             (isEq : isEqualizer (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A g))
                                 (ZeroArrow A (Abelian_Zero A) _ _)
                                 (KernelArrow (Abelian_Zero A) (Abelian_Im A f))
                                 (KernelEqRw (Abelian_Zero A) H)) :
    f ;; g = ZeroArrow A (Abelian_Zero A) _ _.
  Proof.
    set (tmp := maponpaths (fun h' : _ => CokernelArrow (Abelian_Zero A) (Abelian_CoIm A f)
                                                     ;; (Abelian_CoIm_to_Im A f) ;; h') H).
    cbn in tmp. rewrite ZeroArrow_comp_right in tmp.
    apply (maponpaths (fun h' : _ => h' ;; (Abelian_CoIm_to_Im A g)
                                     ;; ((KernelArrow (Abelian_Zero A) (Abelian_Im A g))))) in tmp.
  ...
  Lemma ShortShortExact_from_isShortExact_isEqualizer_eq {a b c : A} (f : a --> b) (g : b --> c)
        (H : (KernelArrow (Abelian_Zero A) (Abelian_Im A f))
               ;; (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A g))
             = ZeroArrow A (Abelian_Zero A) _ _)
        (isEq : isEqualizer (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A g))
                            ...
                            (KernelArrow (Abelian_Zero A) (Abelian_Im A f))
                            (KernelEqRw (Abelian_Zero A) H))
        (w : A) (h : A ⟦w, b⟧) (H' : h ;; g = h ;; ZeroArrow A (Abelian_Zero A) b c) :
    h ;; CokernelArrow (Abelian_Zero A) (Abelian_Cokernel A f) =
    ZeroArrow A (Abelian_Zero A) w (Abelian_Cokernel A f).
  Proof.
    set (ker := mk_Kernel (Abelian_Zero A) (KernelArrow (Abelian_Zero A) (Abelian_Im A f))
                          (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A g)) H isEq).
    rewrite ZeroArrow_comp_right in H'.
  ...
  Lemma ShortShortExact_from_isShortExact_isEqualizer {a b c : A} (f : a --> b) (g : b --> c)
        (H : (KernelArrow (Abelian_Zero A) (Abelian_Im A f))
               ;; (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A g))
             = ZeroArrow A (Abelian_Zero A) _ _)
        (isEq : isEqualizer (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A g))
                            ...
                            (KernelArrow (Abelian_Zero A) (Abelian_Im A f))
                            (KernelEqRw (Abelian_Zero A) H)) :
    let SSED := mk_ShortShortExactData A (Abelian_Zero A) (mk_MorphismPair A f g)
                                       (ShortShortExact_from_isSortExact_eq f g H isEq) in
    isEqualizer g (ZeroArrow A (Abelian_Zero A) b c)
                (KernelArrow (Abelian_Zero A) (ShortShortExactData_Im A SSED))
                (KernelEqRw (Abelian_Zero A) (ShortShortExactData_Im_Eq A hs SSED)).
  Proof.
    cbn zeta.
  ...
  Definition ShortShortExact_from_isShortExact {a b c : A} (f : a --> b) (g : b --> c)
             ...
             (isEq : isEqualizer (CokernelArrow (Abelian_Zero A) (Abelian_CoIm A g))
                                 (ZeroArrow A (Abelian_Zero A) _ _)
                                 (KernelArrow (Abelian_Zero A) (Abelian_Im A f))
                                 (KernelEqRw (Abelian_Zero A) H)) : ShortShortExact A hs.
  Proof.
    use mk_ShortShortExact.
    - use mk_ShortShortExactData.
      + use mk_MorphismPair.
    ...
    - cbn. exact (ShortShortExact_from_isShortExact_isEqualizer f g H isEq).
  Defined.
