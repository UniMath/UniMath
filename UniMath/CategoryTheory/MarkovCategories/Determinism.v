...
We show a series of [pairing_proj] lemmas which show how to express all structure maps as well as constructs 
such as tensor [f #⊗ g] in pairing-projection form. On terms in pairing-projection form, we can make use of a
rewrite system to simplify them automatically. For deterministic morphisms, we can use an η-law to simplify them 
further. This automation strategy [markov_coherence] is complete for equalities between structure maps.
