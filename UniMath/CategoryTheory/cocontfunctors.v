...
Lemma cocone_pr1_functor (cAB : chain (precategory_binproduct A B))
...
Lemma isColimCocone_pr1_functor (cAB : chain (precategory_binproduct A B))
...
Lemma cocone_pr2_functor (cAB : chain (precategory_binproduct A B))
  (ab : A × B) (ccab : cocone cAB ab) :
...
Lemma isColimCocone_pr2_functor (cAB : chain (precategory_binproduct A B))
  (ab : A × B) (ccab : cocone cAB ab) (Hccab : isColimCocone cAB ab ccab) :
...
Definition fun_lt (cAB : chain (precategory_binproduct C C)) :
  Π i j, i < j ->
...
Definition fun_gt (cAB : chain (precategory_binproduct C C)) :
  Π i j, i > j ->
              C ⟦ BinProductObject C (PC (ob1 (dob cAB i)) (ob2 (dob cAB j))),
...
Definition map_to_K (cAB : chain (precategory_binproduct C C)) (K : C)
...
Lemma map_to_K_commutes (cAB : chain (precategory_binproduct C C)) (K : C)
...
Lemma ccAiB_K (cAB : chain (precategory_binproduct C C)) (K : C)
...
Variable cAB : chain (precategory_binproduct C C).
Variable LM : C × C.
