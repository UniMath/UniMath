...
Section UnitLayer.
  ...
  Definition bicatcatsunit_totalcategory : bicat := total_bicat  bicatcatsunit_disp_bicat.

  Definition bicatcatsunit_totalcategory_is_univalent_2_1 : is_univalent_2_1 bicatcatsunit_totalcategory.
  Proof.
  ...
  Definition bicatcatsunit_totalcategory_is_univalent_2_0 : is_univalent_2_0 bicatcatsunit_totalcategory.
  Proof.
    apply total_is_univalent_2_0.
    - apply univalent_cat_is_univalent_2_0.
    - apply bicatcatsunit_disp_prebicat_is_globally_univalent.
  Defined.

  Definition bicatcatsunit_totalcategory_is_univalent : is_univalent_2 bicatcatsunit_totalcategory.
  Proof.
    use tpair.
    - exact bicatcatsunit_totalcategory_is_univalent_2_0.
    - exact bicatcatsunit_totalcategory_is_univalent_2_1.
  Defined.
