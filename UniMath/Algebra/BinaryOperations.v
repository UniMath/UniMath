...
Proof.
  intros X R x x' r R' H. exact (H x x' r).
Defined.
...
Definition pullback_binopeqrel {X Y : setwithbinop} (f : binopfun X Y) (R : binopeqrel Y) :
  binopeqrel X.
Proof.
  intros X Y f R. use binopeqrelpair.
  - use eqrelpair.
...
Proof.
  intros. apply (pullback_binopeqrel f). use binopeqrelpair.
  - exact R.
...
Proof.
  intros X Y R f H x x' r. exact (r (binopeqrel_of_binopfun f) H).
Defined.
...
Proof.
  intros X Y R S f H x x' r. apply (r (pullback_binopeqrel f (generated_binopeqrel S))).
...
Lemma iscomprelrelfun_generated_binopeqrel_rev {X Y : setwithbinop} {R : hrel X} {S : hrel Y}
  ...
  iscomprelrelfun (generated_binopeqrel R) (generated_binopeqrel S) f.
Proof.
  intros X Y R S f H x x' r. apply (r (pullback_binopeqrel_rev f (generated_binopeqrel S))).
  intros x1 x2 r' S' s. use s. apply H. exact r'.
Defined.
