...
Definition Dcuts_def_error (X : hsubtype NonnegativeRationals) : UU :=
  Π r : NonnegativeRationals, 0 < r -> (¬ (X r)) ∨ Σ q : NonnegativeRationals, (X q) × (¬ (X (q + r))).

Lemma Dcuts_def_error_finite (X : hsubtype NonnegativeRationals) :
...
Lemma Dcuts_def_error_not_empty (X : hsubtype NonnegativeRationals) :
...
Proof.
  ...
  now apply pr2.
Qed.
Lemma isaprop_Dcuts_def_error (X : hsubtype NonnegativeRationals) : isaprop (Dcuts_def_error X).
Proof.
  intros X.
  repeat (apply impred_isaprop ; intro).
  now apply pr2.
...
Definition Dcuts_of_Dcuts (E : hsubtype Dcuts) E_bot E_error : Dcuts :=
...
Lemma isub_Dcuts_of_Dcuts (E : hsubtype Dcuts) E_bot E_error :
...
Proof.
  ...
  now exists x.
Qed.
Lemma islbub_Dcuts_of_Dcuts (E : hsubtype Dcuts) E_bot E_error :
...
Proof.
  ...
  exact (pr2 (pr2 y)).
Qed.
Lemma islub_Dcuts_of_Dcuts (E : hsubtype eo_Dcuts) E_bot E_error :
