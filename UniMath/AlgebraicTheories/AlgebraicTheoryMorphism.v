...
Definition algebraic_theory_morphism_data_to_nat_trans_data {T T'} (F : algebraic_theory_morphism_data T T') : nat_trans_data (algebraic_theory_data_to_functor_data T) (algebraic_theory_data_to_functor_data T') := F.
...
Definition is_algebraic_theory_morphism {T T' : algebraic_theory} (F : algebraic_theory_morphism_data T T') : Prop :=
...
Definition algebraic_theory_morphism_to_algebraic_theory_morphism_data {T T'} (F : algebraic_theory_morphism T T') : algebraic_theory_morphism_data T T' := pr1 F.
Coercion algebraic_theory_morphism_to_algebraic_theory_morphism_data : algebraic_theory_morphism >-> algebraic_theory_morphism_data.

Definition algebraic_theory_morphism_to_nat_trans {T T'} (F : algebraic_theory_morphism T T') : (algebraic_theory_to_functor T) ⟹ (algebraic_theory_to_functor T') := make_nat_trans _ _ (algebraic_theory_morphism_data_to_nat_trans_data F) (pr12 F).

Lemma algebraic_theory_morphism_eq {T T'} (F F' : algebraic_theory_morphism T T') (H1 : ∏ n f, pr1 F n f = pr1 F' n f) : F = F'.
Proof.
