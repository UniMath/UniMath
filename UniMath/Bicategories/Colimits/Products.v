    ...
    Definition has_binprod_ump_2_cell_pr1
      ...
      := ∏ (q : binprod_cone)
           ...
           (β : φ · binprod_cone_pr2 p
                ==>
                ψ · binprod_cone_pr2 p),
         υ q φ ψ α β ▹ binprod_cone_pr1 p = α.
    ...
    Definition has_binprod_ump_2_cell_pr2
      ...
      := ∏ (q : binprod_cone)
           ...
           (β : φ · binprod_cone_pr2 p
                ==>
                ψ · binprod_cone_pr2 p),
         υ q φ ψ α β ▹ binprod_cone_pr2 p = β.
...
Section Projections.
  ...
  Definition binprod_pr1
             (b₁ b₂ : B)
    : b₁ ⊗ b₂ --> b₁
    := binprod_cone_pr1 (pr1 (HB b₁ b₂)).

  Definition binprod_pr2
             (b₁ b₂ : B)
    : b₁ ⊗ b₂ --> b₂
    := binprod_cone_pr2 (pr1 (HB b₁ b₂)).
  ...
  Definition pair_1cell
             ...
             (g : a --> b₂)
    : a --> b₁ ⊗ b₂
    := pr12 (HB b₁ b₂) (make_binprod_cone a f g).
  ...
  Definition pair_1cell_pr1
    ...
    := binprod_1cell_pr1 (pr12 (HB b₁ b₂) (make_binprod_cone a f g)).
  ...
  Definition pair_1cell_pr2
    ...
    := binprod_1cell_pr2 (pr12 (HB b₁ b₂) (make_binprod_cone a f g)).
  ...
  Definition pair_2cell
    ...
    : ⟨ f₁ , g₁ ⟩ ==> ⟨ f₂ , g₂ ⟩
    := pr11 (pr22 (HB b₁ b₂)
                  (make_binprod_cone a f₂ g₂)
                  ⟨ f₁ , g₁ ⟩
                  ⟨ f₂ , g₂ ⟩
                  (pair_1cell_pr1 f₁ g₁ • α • (pair_1cell_pr1 f₂ g₂)^-1)
                  (pair_1cell_pr2 f₁ g₁ • β • (pair_1cell_pr2 f₂ g₂)^-1)).
  ...
  Definition pair_2cell_pr1
             ...
             (α : f₁ ==> f₂)
             (β : g₁ ==> g₂)
    : ⟨⟨ α , β ⟩⟩ ▹ π₁ • pair_1cell_pr1 _ _
      =
      pair_1cell_pr1 _ _ • α.
  Proof.
    use vcomp_move_R_Mp.
    {
      apply pair_1cell_pr1.
    }
    exact (pr121 (pr22 (HB b₁ b₂)
                       (make_binprod_cone a f₂ g₂)
                       ⟨ f₁ , g₁ ⟩
                       ⟨ f₂ , g₂ ⟩
                       (pair_1cell_pr1 f₁ g₁ • α • (pair_1cell_pr1 f₂ g₂)^-1)
  ...
  Definition pair_2cell_pr2
             ...
             (α : f₁ ==> f₂)
             (β : g₁ ==> g₂)
    : ⟨⟨ α , β ⟩⟩ ▹ π₂ • pair_1cell_pr2 _ _
      =
      pair_1cell_pr2 _ _ • β.
  Proof.
    use vcomp_move_R_Mp.
    {
      apply pair_1cell_pr2.
    }
    exact (pr221 (pr22 (HB b₁ b₂)
                       (make_binprod_cone a f₂ g₂)
                       ⟨ f₁ , g₁ ⟩
                       ⟨ f₂ , g₂ ⟩
                       (pair_1cell_pr1 f₁ g₁ • α • (pair_1cell_pr1 f₂ g₂)^-1)
...
Local Notation "b₁ ⊗ b₂" := (binprod _ b₁ b₂).
Local Notation "'π₁'" := (binprod_pr1 _ _ _).
Local Notation "'π₂'" := (binprod_pr2 _ _ _).
Local Notation "⟨ f , g ⟩" := (pair_1cell _ f g).
Local Notation "⟨⟨ α , β ⟩⟩" := (pair_2cell _ α β).
