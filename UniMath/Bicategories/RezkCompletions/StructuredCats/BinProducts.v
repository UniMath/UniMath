...
Section BicatOfCategoriesWithChosenBinproductsHasRezkCompletion.
  ...
  Definition weak_equiv_preserves_binprod_univ
    {C1 C2 : category}
  ...
  Lemma weak_equiv_lifts_preserves_chosen_binproducts_eq {C1 : category}
    (C2 C3 : univalent_category)
    {F : C1 ⟶ C3}
    {G : C1 ⟶ C2}
    {H : C2 ⟶ C3}
  ...
  Proof.
    ...
    - intros C1 C2 C2_univ F Fw C1_prod.
      exact (weak_equiv_preserves_binprod_univ C2_univ Fw (pr1 C1_prod) ,, tt).
    - intros C C1_prod.
      refine (tt ,, _).
