...
Definition cat_monad_ημ {C : category} (M : monad bicat_of_cats C)
...
Definition cat_monad_μη {C : category} (M : monad bicat_of_cats C)
...
Definition cat_monad_μμ {C : category} (M : monad bicat_of_cats C)
  : ∏ (X : C),
