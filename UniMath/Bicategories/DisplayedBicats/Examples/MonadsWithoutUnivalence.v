...
Definition cat_monad_ημ {C : category} (M : monad bicat_of_cats_nouniv C)
...
Definition cat_monad_μη {C : category} (M : monad bicat_of_cats_nouniv C)
...
Definition cat_monad_μμ {C : category} (M : monad bicat_of_cats_nouniv C)
  : ∏ (X : C),
...
Context {C : category}
        (M : monad bicat_of_cats_nouniv C).
...
(* ------------------------------------------------------------------------- *)
(* Monad morphism on C = bicat_of_cats_nouniv.                                      *)
(* ------------------------------------------------------------------------- *)

Definition make_cat_monad_mor
           {C D : category}
           {mx : monad bicat_of_cats_nouniv C} {my : monad bicat_of_cats_nouniv D}
           {F : C ⟶ D}
...
Definition make_cat_monad_cell
           {C D : category}
           {mx : monad bicat_of_cats_nouniv C}
           {my : monad bicat_of_cats_nouniv D}
           {f g : C ⟶ D}
           {α : f ⟹ g}
           {mf : mx -->[f] my}
           {mg : mx -->[g] my}
  ...
  : mf ==>[α: prebicat_cells bicat_of_cats_nouniv _ _] mg.
Proof.
